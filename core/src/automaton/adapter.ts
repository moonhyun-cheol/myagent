...
export const AUTOMATON_UNCONFIGURED_MESSAGE =
  '**automaton 미설정** — 실행 통로(OpenClaw 어댑터 또는 로컬 automaton)가 없습니다. 조직 모듈 adapter-connection.json(허브 URL+bootstrap) 또는 data/vault/openclaw-adapter.json, 또는 env OPENCLAW_ADAPTER_BASE_URL + OPENCLAW_ADAPTER_TOKEN 을 설정하세요.';
