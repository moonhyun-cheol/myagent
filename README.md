...
**1.1.0** · seq **23** · [`moonhyun-cheol/myagent`](https://github.com/moonhyun-cheol/myagent)
...
서명이 맞고 `update_sequence`가 **지금보다 크면** 확인창 → `MYAgent.Updater.exe`가 델타 zip을 적용합니다. SemVer가 아니라 **seq 숫자**가 기준입니다. 지금 피드는 seq **23**입니다. 첫 설치는 릴리스의 **install zip**입니다.
