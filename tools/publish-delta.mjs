...
if (secureUpdate) {
  ...
  const payloadDocument = buildPayloadManifest(stageDir, {
    ...
    deleted: [
      ...
      'tools/verify-launcher-update.mjs',
      'tools/install/install-launcher.bat',
      'tools/install/install-launcher.ps1',
      'tools/install/install-launcher-ui.ps1',
      'tools/install/install-launcher-discovery.ps1',
      'tools/install/install-launcher-shortcut.ps1',
    ],
  });
