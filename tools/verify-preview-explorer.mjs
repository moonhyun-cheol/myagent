...
assert.match(ui, /data-testid="open-workspace-explorer"/);
assert.match(ui, /openWorkspaceRootInExplorer\(\)/);
assert.match(ui, /work-panel-tool-button/);
assert.doesNotMatch(objects, /data-testid="open-workspace-explorer"/);
